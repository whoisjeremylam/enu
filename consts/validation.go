...
var ParameterValidations = map[string]Validations{
	...
	"ripple": {
		...
		"activateaddress": `{"properties":{"blockchainId":{"type":"string"},"address":{"type":"string","maxLength":34,"minLength":34},"passphrase":{"type":"string"},"amount":{"type":"integer"},"assets":{"type":"object","properties":{"currency":{"type":"string"},"issuer":{"type":"string"}}},"nonce":{"type":"integer"}},"required":["address","amount"]}`,
	},
}
