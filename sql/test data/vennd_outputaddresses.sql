...
--
-- Dumping data for table `outputaddresses`
--

LOCK TABLES `outputaddresses` WRITE;
/*!40000 ALTER TABLE `outputaddresses` DISABLE KEYS */;
/*!40000 ALTER TABLE `outputaddresses` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2015-12-11  3:47:57
